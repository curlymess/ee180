...
extern pthread_barrier_t gray_barrier;
extern pthread_barrier_t presobel_barrier;
extern pthread_barrier_t pregray_barrier;
extern pthread_barrier_t while_barrier;
extern pthread_barrier_t sobel_barrier;

extern pthread_barrier_t q_barrier;
extern pthread_barrier_t endSobel;
extern pthread_barrier_t vid_barrier;
